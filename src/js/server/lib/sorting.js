...
//
gpii.ptd.api.lib.sorting.isEmpty = function (value) {
...
gpii.ptd.api.lib.sorting.generateSortFunction = function (rawParam) {
    ...
    return function (a, b) {
        ...
        var aIsEmpty = gpii.ptd.api.lib.sorting.isEmpty(typedValueA);
        var bIsEmpty = gpii.ptd.api.lib.sorting.isEmpty(typedValueB);
        if (typedValueA === typedValueB) {
            ...
            if (typedValueA < typedValueB)      { return -1 * direction; }
